...
public class NoticeListAdapter extends RecyclerView.Adapter<NoticeListAdapter.TransactionViewHolder> {
    private final Context context;
    private List<FinishFebricsMaster> items;

    public NoticeListAdapter(List<FinishFebricsMaster> items, Context context) {
        this.items = items;
    ...
    public void onBindViewHolder(TransactionViewHolder holder, int position) {
        FinishFebricsMaster item = items.get(position);
        holder.set(item);
    }
    ...
    public class TransactionViewHolder extends RecyclerView.ViewHolder {
        ...
        public void set(final FinishFebricsMaster item) {
            //UI setting code
