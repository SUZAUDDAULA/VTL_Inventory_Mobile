...
import com.opus_bd.stockmanagement.Activity.StockOut.FinishedFebricActivity;
...
public class StockOutFebricDetailsListAdapter extends RecyclerView.Adapter<StockOutFebricDetailsListAdapter.TransactionViewHolder> {
    private final Context context;
    private List<CurrentFebricDetails> items;

    public StockOutFebricDetailsListAdapter(List<CurrentFebricDetails> items, Context context) {
        this.items = items;
        ...
        public void set(final CurrentFebricDetails item) {
            ...
            rootLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, FinishedFebricActivity.class);
