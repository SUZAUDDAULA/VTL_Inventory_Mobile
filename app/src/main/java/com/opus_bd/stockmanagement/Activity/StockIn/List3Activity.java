...
public class List3Activity extends AppCompatActivity {
    ...
    public void getAllList(int id) {
        ...
        if (token != null) {
            Call<List<FinishFabricStorageByRecevedNo>> registrationRequest = retrofitService.GetFinishFabricStorageByRecevedNo(SharedPrefManager.BEARER + token, id);
                ...
                registrationRequest.enqueue(new Callback<List<FinishFabricStorageByRecevedNo>>() {
                    ...
                    public void onResponse(Call<List<FinishFabricStorageByRecevedNo>> call, @NonNull Response<List<FinishFabricStorageByRecevedNo>> response) {
                        if (response.body() != null) {
                            ...
                            Toasty.error(List3Activity.this, "SESSION_EXPIRED", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(List3Activity.this, LoginActivity.class);
