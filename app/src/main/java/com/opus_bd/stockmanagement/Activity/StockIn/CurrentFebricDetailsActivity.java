...
public class CurrentFebricDetailsActivity extends AppCompatActivity {
    @BindView(R.id.rvNotice)
    RecyclerView rvNotice;

    CurrentFebricDetailsListAdapter noticeListAdapter;
    ...
    public void intRecyclerView() {
        noticeListAdapter = new CurrentFebricDetailsListAdapter(noticeArrayList, this);
    ...
    public void getAllList(int id) {
        ...
        if (token != null) {
            Call<List<CurrentFebricDetails>> registrationRequest = retrofitService.GetAllCurrentFebricDetailsByReceiveId(SharedPrefManager.BEARER + token,id);
                ...
                registrationRequest.enqueue(new Callback<List<CurrentFebricDetails>>() {
                    ...
                    public void onResponse(Call<List<CurrentFebricDetails>> call, @NonNull Response<List<CurrentFebricDetails>> response) {
                        if (response.body() != null) {
                            ...
                            Toasty.error(CurrentFebricDetailsActivity.this, "SESSION_EXPIRED", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CurrentFebricDetailsActivity.this, List2Activity.class);
